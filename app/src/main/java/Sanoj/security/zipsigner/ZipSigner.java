...
import Sanoj.zipio.ZioEntry;
import Sanoj.zipio.ZipInput;
import Sanoj.zipio.ZipOutput;
        ...
        throws IOException, GeneralSecurityException
    {
        if (keySet.getSigBlockTemplate() != null) {
            ...
            try {
                ...
                Class generatorClass = Class.forName("Sanoj.security.zipsigner.optional.SignatureBlockGenerator");
