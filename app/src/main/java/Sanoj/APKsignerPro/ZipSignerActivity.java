...
import Sanoj.security.zipsigner.optional.CustomKeySigner;
import Sanoj.security.zipsigner.optional.PasswordObfuscator;
...
import Sanoj.security.zipsigner.ProgressEvent;
import Sanoj.security.zipsigner.ZipSigner;
import Sanoj.security.zipsigner.ProgressListener;
import Sanoj.security.zipsigner.AutoKeyException;
...
import Sanoj.APKsignerPro.customkeys.*;
...
public class ZipSignerActivity extends Activity {
    ...
    private int docs = 0;
    private String tmpStr10 = String.valueOf(docs);
...
// hide the navigation bar.
        ...
        mWaveLoadingView.setCenterTitle(tmpStr10+"%");
        mWaveLoadingView.setCenterTitleColor(Color.BLACK);
        mWaveLoadingView.setCenterTitleStrokeColor(Color.WHITE);
        mWaveLoadingView.setCenterTitleStrokeWidth(5);
    ...
    final Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_TYPE_PERCENT_DONE:
                ...
                mWaveLoadingView.setProgressValue(percentDone);
                String tmpStr101 = String.valueOf(percentDone);
                mWaveLoadingView.setCenterTitle(tmpStr101+"%");
